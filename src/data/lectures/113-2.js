export const semesterData = [
  {
    ...
    "type": "主線",
    "description": "📢 新學期開始啦！你是不是也很好奇這學期的社課和活動安排呢？<br>想知道有哪些有趣的企劃等著大家一起參與嗎？那這場期初茶會你絕對不能錯過！✨<br><br>這次的活動不僅會帶你深入了解新學期的社團規劃 📋，還能和幹部、社員們輕鬆聊聊 💭，提出你的想法，甚至發現志同道合的夥伴！<br>不論你是剛加入的新朋友 🆕，還是已經參加過活動的老朋友 👋，我們都熱情歡迎你的到來～ 🎉<br><br>讓我們一起迎接全新的學期、全新的可能！🎊",
    "timeline": [
  ...
  },
  {
    ...
    "type": "主線",
    "description": "在程式開發的學習過程中，Debug(除錯)往往是最耗時且令人沮喪的環節。傳統教學較注重語法和解題，容易忽略除錯技巧的培養。當程式發生錯誤，例如出現`SIGSEGV`(Segmentation Fault)時，新手往往難以找到問題根源，只能靠運氣或土法煉鋼的方式除錯。<br><br>GDB (GNU Debugger) 是一款歷史悠久且功能強大的除錯工具，廣泛應用於軟體開發、系統分析、資訊安全等領域。透過 GDB，開發者可以逐步追蹤程式碼的執行流程、檢視變數內容、分析記憶體狀態，從而快速定位並解決問題。<br><br>本次社課希望引導社員及對程式開發有興趣的同學，認識 GDB 這個強大的工具，擺脫以往 printf 大法低效率的除錯方式，學會利用更有效率的工具來解決問題，提升程式開發能力。",
    "timeline": [
      "17:30~18:00 場地佈置、進場",
      "18:00~19:30 GDB使用教學",
      "19:30~19:50 實作練習",
