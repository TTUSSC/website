...
const lectureData = {
  '2025-fall': [
    ...
    },
    {
      ...
      location: "A3-200",
      tags: ["資訊安全"],
      description: "你對駭客好奇嗎？本次社課將帶你揭開駭客文化的神祕面紗，從真實世界的傳奇駭客故事、資訊安全的實際應用，到動手滲透靶機，讓你從零開始體驗駭客世界的刺激與魅力！想知道成為駭客需要什麼條件？來參加，就從這一刻開始——現在，正式是駭客的時刻！
建議攜帶筆電並事先安裝 VMware，活動中將提供靶機操作與滲透體驗。無須資安背景，對駭客文化與電腦系統有興趣者皆歡迎參加！",
      timeline: [
